...
namespace DG.Tweening.Plugins.Core
{
	public static class PluginsManager
	{
		...
		public static ABSTweenPlugin<T1, T2, TPlugOptions> GetDefaultPlugin<T1, T2, TPlugOptions>() where TPlugOptions : struct
		{
		...
		public static ABSTweenPlugin<T1, T2, TPlugOptions> GetCustomPlugin<TPlugin, T1, T2, TPlugOptions>() where TPlugin : ITweenPlugin, new() where TPlugOptions : struct
		{
			...
			tweenPlugin = ((default(TPlugin) == null) ? Activator.CreateInstance<TPlugin>() : default(TPlugin));
